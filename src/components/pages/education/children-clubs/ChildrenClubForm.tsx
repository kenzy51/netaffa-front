...
import PuzzleGirls from 'public/images/png/puzzleGirls.png'
...
const ChildrenClubForm = ({ children }: IChildren) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      await toast.promise(formDataHttp(values, '/children_clubs/children-club-forms/', 'POST'), {
        pending: 'Загрузка...',
        success: 'Успех!',
        error: 'Ошибочка...',
      })
...
export default ChildrenClubForm
